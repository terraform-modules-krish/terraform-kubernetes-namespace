...
[`namespace`](https://github.com/terraform-modules-krish/terraform-kubernetes-namespace/blob/main/modules/namespace) module, and create two new `ServiceAccounts`:
