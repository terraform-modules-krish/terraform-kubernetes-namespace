...
[`namespace`](https://github.com/terraform-modules-krish/terraform-kubernetes-namespace/blob/v0.5.1/modules/namespace) module, and create two new `ServiceAccounts`:
