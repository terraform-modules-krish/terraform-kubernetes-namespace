...
[`namespace`](https://github.com/terraform-modules-krish/terraform-kubernetes-namespace/blob/v0.2.0/modules/namespace) module, and create two new `ServiceAccounts`:
